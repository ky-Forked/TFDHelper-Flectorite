...
namespace Menu
{
	...
	/* THESE ARE IMPORTANT FOR IMGUI::HOTKEY! YOU NEED ONE FOR EVERY UNIQUE KEYBIND*/
	extern bool cfg_ShowMenuKeyState;
	extern bool cfg_LootVacuumKeyState;
	extern bool cfg_AimbotHoldKeyState;
	extern bool cfg_AimbotToggleKeyState;
	extern bool cfg_TimescaleHoldKeyState;
	extern bool cfg_TimescaleToggleKeyState;
	extern bool cfg_MissionAutoRestartKeyState;
